# eVisit UI — AI Development Rules (Gemini)

> This file is for Google Gemini. The source of truth is `CLAUDE.md`.
...
This project has workflow checklists in `.claude/skills/`. Although they are stored in the Claude Code directory, they are generic markdown checklists that any AI can follow.
